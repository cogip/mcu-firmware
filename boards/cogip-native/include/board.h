...
#define GPIO_VACUUM1_ENABLE GPIO_PIN(0, 13)
#define GPIO_VACUUM1_TEST GPIO_PIN(0, 0)
#define GPIO_VACUUM2_ENABLE GPIO_PIN(0, 14)
#define GPIO_VACUUM2_TEST GPIO_PIN(0, 1)
#define GPIO_VACUUM3_ENABLE GPIO_PIN(0, 15)
#define GPIO_VACUUM3_TEST GPIO_PIN(0, 2)
