...
public:
    ...
    double right_wheel_diameter, double axle_track, double left_polarity, double right_polarity) : left_wheel_diameter_(left_wheel_diameter), right_wheel_diameter_(right_wheel_diameter), axle_track_(axle_track), left_polarity_(left_polarity), right_polarity_(right_polarity) {};
