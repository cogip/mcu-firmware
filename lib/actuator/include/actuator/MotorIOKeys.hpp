...
// ============================================================================
// Tracker Chain Safety Filter IO Keys
// ============================================================================

/// @brief IO keys for SpeedLimitFilter in tracker chain (safety clamp)
/// @details Operates on speed_order in-place to clamp excessive speed commands
static const motion_control::SpeedLimitFilterIOKeys motor_tracker_speed_limit_io_keys = {
    .target_speed = "speed_order", .output_speed = ""};

/// @brief IO keys for AccelerationFilter in tracker chain (safety clamp)
/// @details Operates on speed_order in-place to limit speed increase rate
static const motion_control::AccelerationFilterIOKeys motor_tracker_acceleration_io_keys = {
    .target_speed = "speed_order"};

/// @brief IO keys for DecelerationFilter in tracker chain (safety clamp)
/// @details Reduces speed_order based on remaining distance to prevent overshoot
static const motion_control::DecelerationFilterIOKeys motor_tracker_deceleration_io_keys = {
    .pose_error = "pose_error",
    .current_speed = "current_speed",
    .target_speed = "speed_order",
    .output_speed = ""};
