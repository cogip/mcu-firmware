...
static cogip::pid::PID linear_speed_pid(linear_speed_pid_kp, linear_speed_pid_ki, linear_speed_pid_kd,
					linear_speed_pid_integral_limit);
// Angular pose PID controller
static cogip::pid::PID angular_pose_pid(angular_pose_pid_kp, angular_pose_pid_ki, angular_pose_pid_kd,
					angular_pose_pid_integral_limit);
// Angular speed PID controller
static cogip::pid::PID angular_speed_pid(angular_speed_pid_kp, angular_speed_pid_ki, angular_speed_pid_kd,
...
static cogip::motion_control::SpeedFilterParameters
	linear_speed_filter_parameters(platform_min_speed_linear_mm_per_period, platform_max_speed_linear_mm_per_period,
...
static cogip::motion_control::PassthroughPosePIDController
	passthrough_linear_pose_controller(&passthrough_linear_pose_controller_parameters);
...
/// target speed as speed order.
static cogip::motion_control::PassthroughPosePIDController
	passthrough_angular_pose_controller(&passthrough_angular_pose_controller_parameters);
...
/// Encoders
#ifdef CPU_NATIVE
static cogip::encoder::EncoderQDEC left_encoder(MOTOR_LEFT, cogip::encoder::EncoderMode::ENCODER_MODE_X1,
						wheels_encoder_resolution);
static cogip::encoder::EncoderQDEC right_encoder(MOTOR_RIGHT, cogip::encoder::EncoderMode::ENCODER_MODE_X1,
						 wheels_encoder_resolution);
#else
static cogip::encoder::EncoderQDEC left_encoder(MOTOR_LEFT, cogip::encoder::EncoderMode::ENCODER_MODE_X4,
						encoder_wheels_resolution_pulses);
static cogip::encoder::EncoderQDEC right_encoder(MOTOR_RIGHT, cogip::encoder::EncoderMode::ENCODER_MODE_X4,
						 encoder_wheels_resolution_pulses);
#endif

/// Odometry
static cogip::odometer::OdometerDifferentialParameters odometry_params(left_encoder_wheels_diameter_mm, right_encoder_wheels_diameter_mm, encoder_wheels_distance_mm,
								       QDEC_LEFT_POLARITY, QDEC_RIGHT_POLARITY);
...
static cogip::drive_controller::DifferentialDriveControllerParameters
	drive_controller_params(motor_wheels_diameter_mm, motor_wheels_diameter_mm, motor_wheels_distance_mm, left_motor_constant, right_motor_constant, pwm_minimal, max_motor_speed_percent,
				motion_control_thread_period_ms);

static cogip::drive_controller::DifferentialDriveController drive_controller(drive_controller_params, left_motor,
									     right_motor);

// Motion control engine
static cogip::motion_control::PlatformEngine
	pf_motion_control_platform_engine(odometry, drive_controller,
...
void pf_handle_target_pose(cogip::canpb::ReadBuffer &buffer)
{
	...
	target_pose.bypass_final_orientation() ? pose_straight_filter_parameters.bypass_final_orientation_on()
