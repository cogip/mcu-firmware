...
///
/// @{
constexpr double wheels_diameter_mm = 60;
constexpr double wheels_distance_mm = 89.8;
constexpr double wheels_encoder_resolution = 16 * 4 * 8;
constexpr double wheels_perimeter = M_PI * wheels_diameter_mm;
constexpr double pulse_per_mm =
	wheels_encoder_resolution / wheels_perimeter; ///< WHEELS_ENCODER_RESOLUTION / WHEELS_PERIMETER
...
/// Minimal PWM value
constexpr double pwm_minimal = 0;
...
constexpr double platform_max_dec_m_per_s2 = 0.6;  ///< Maximum deceleration (m/s²)
constexpr double platform_max_acc_linear_mm_per_period2 =
	((1000 * platform_max_acc_m_per_s2 * motion_control_thread_period_ms * motion_control_thread_period_ms) /
	 (1000 * 1000)); ///< Maximum linear acceleration (mm/<motion_control_thread_period_ms>²)
constexpr double platform_max_dec_linear_mm_per_period2 =
	((1000 * platform_max_dec_m_per_s2 * motion_control_thread_period_ms * motion_control_thread_period_ms) /
	 (1000 * 1000)); ///< Maximum linear deceleration (mm/<motion_control_thread_period_ms>²)
...
constexpr double platform_low_speed_linear_mm_per_period =
	(platform_max_speed_linear_mm_per_period / 4); ///< Low angular speed (deg/<motion_control_thread_period_ms>)
constexpr double platform_normal_speed_linear_mm_per_period =
	(platform_max_speed_linear_mm_per_period / 2); ///< Normal angular speed (deg/<motion_control_thread_period_ms>)
// Linear antiblocking
...
constexpr double platform_max_speed_deg_per_s = 45; ///< Maximum speed (deg/s)
constexpr double platform_max_acc_deg_per_s2 = 45;  ///< Maximum acceleration (deg/s²)
constexpr double platform_max_dec_deg_per_s2 = 45;  ///< Maximum deceleration (deg/s²)
constexpr double platform_max_acc_angular_deg_per_period2 =
	((platform_max_acc_deg_per_s2 * motion_control_thread_period_ms * motion_control_thread_period_ms) /
	 (1000 * 1000)); ///< Maximum angular acceleration (deg/<motion_control_thread_period_ms>)
constexpr double platform_max_dec_angular_deg_per_period2 =
	((platform_max_dec_deg_per_s2 * motion_control_thread_period_ms * motion_control_thread_period_ms) /
	 (1000 * 1000)); ///< Maximum angular deceleration (deg/<motion_control_thread_period_ms>)
...
constexpr double platform_low_speed_angular_deg_per_period =
	(platform_max_speed_angular_deg_per_period / 4); ///< Low angular speed (deg/<motion_control_thread_period_ms>)
constexpr double platform_normal_speed_angular_deg_per_period =
	(platform_max_speed_angular_deg_per_period /
	 2); ///< Normal angular speed (deg/<motion_control_thread_period_ms>)
