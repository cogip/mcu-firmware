...
using cogip::pf_common::path_add_point_uuid;
using cogip::pf_common::path_complete_uuid;
using cogip::pf_common::path_reset_uuid;
using cogip::pf_common::path_start_uuid;
