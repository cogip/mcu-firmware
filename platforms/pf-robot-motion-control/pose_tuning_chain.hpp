...
inline cogip::motion_control::PoseErrorFilterParameters linear_pose_error_filter_parameters(
    cogip::motion_control::PoseErrorFilterMode::LINEAR, 0.0f);
...
inline cogip::motion_control::ProfileFeedforwardControllerIOKeys linear_profile_feedforward_io_keys = {
    .pose_error = "linear_pose_error",
...
inline cogip::motion_control::PoseErrorFilterParameters angular_pose_error_filter_parameters(
    cogip::motion_control::PoseErrorFilterMode::ANGULAR, 0.0f);

inline cogip::motion_control::PoseErrorFilter
    angular_pose_error_filter(angular_pose_error_filter_io_keys, angular_pose_error_filter_parameters);

// ProfileFeedforwardController for angular
inline cogip::motion_control::ProfileFeedforwardControllerIOKeys angular_profile_feedforward_io_keys = {
    .pose_error = "angular_pose_error",
...
inline cogip::motion_control::MetaController<2> angular_pose_loop_meta_controller;  // Simplified: PoseErrorFilter + PosePID only
