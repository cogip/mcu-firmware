...
/// Lifts memory pool
static etl::pool<cogip::actuators::positional_actuators::Lift, CONFIG_ACTUATOR_LIFT_NUMBER>
    _lifts_pool;
...
static etl::map<cogip::actuators::Enum, cogip::actuators::positional_actuators::PositionalActuator*,
                _actuator_total_number>
    _positional_actuators;

void disable_all()
{
    for (auto& iterator : _positional_actuators) {
        cogip::actuators::positional_actuators::PositionalActuator* positional_actuator =
            iterator.second;
...
void send_state(cogip::actuators::Enum positional_actuator)
{
    ...
    positional_actuators::get(positional_actuator)
        .pb_copy(_pb_actuator_state.mutable_positional_actuator());
