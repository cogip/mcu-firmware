...
/// @ingroup    profile_tracker_controller Profile Tracker controller IO keys
/// @{
/// @file
/// @brief      Profile Tracker controller IO keys
...
/// @brief Bundle of ControllersIO key names for ProfileTrackerController.
///
/// This controller generates a trapezoidal velocity profile and computes:
/// - tracker velocity (from the profile)
...
struct ProfileTrackerControllerIOKeys
{
    ...
    etl::string_view tracker_velocity;  ///< e.g. "linear_tracker_velocity" (output)
