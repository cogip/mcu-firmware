                                                        ...
                                                        AdaptivePurePursuitControllerParameters>
{
  public:
    ...
    explicit AdaptivePurePursuitController(
        ...
        const AdaptivePurePursuitControllerParameters& parameters, path::Path& path,
        etl::string_view name = "")
        : Controller<AdaptivePurePursuitControllerIOKeys, AdaptivePurePursuitControllerParameters>(
              keys, parameters, name),
          path_(path), current_segment_index_(0), current_segment_param_(0.0f),
          direction_locked_(false), locked_go_backward_(false),
          state_(State::ROTATING_TO_DIRECTION), first_rotating_cycle_(true), needs_path_init_(true),
