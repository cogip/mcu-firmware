...
/// @endcode
class FeedforwardCombinerController
    : public Controller<FeedforwardCombinerControllerIOKeys, FeedforwardCombinerControllerParameters>
{
  public:
    /// @brief Constructor
    /// @param keys       Reference to a POD containing all controller keys
    /// @param parameters Reference to controller parameters (empty)
    explicit FeedforwardCombinerController(const FeedforwardCombinerControllerIOKeys& keys,
                                           const FeedforwardCombinerControllerParameters& parameters)
        : Controller<FeedforwardCombinerControllerIOKeys, FeedforwardCombinerControllerParameters>(keys, parameters)
    {
    }
