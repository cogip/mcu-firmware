...
public:
    ...
    ///        This value is useful to convert linear velocity in mm/s to a speed ratio between 0 to 100%.
    ///        This speed ratio need to be applied to the max motor voltage in order to get the voltage needed
