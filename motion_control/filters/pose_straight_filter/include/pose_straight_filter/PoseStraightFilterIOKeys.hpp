...
struct PoseStraightFilterIOKeys {
    ...
    etl::string_view linear_current_speed;   ///< key for linear component of current speed output
    ...
    etl::string_view angular_current_speed;  ///< key for angular component of current speed output
