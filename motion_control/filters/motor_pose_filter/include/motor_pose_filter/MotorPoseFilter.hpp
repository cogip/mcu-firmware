...
class MotorPoseFilter
    : public Controller<MotorPoseFilterParameters, MotorPoseFilterIOKeys>
{
public:
    /// @brief Constructor.
    /// @param parameters Pointer to parameters.
    /// @param keys       Pointer to IO keys.
    explicit MotorPoseFilter(
        MotorPoseFilterParameters*       parameters,
        const MotorPoseFilterIOKeys*     keys
    )
        : Controller<MotorPoseFilterParameters, MotorPoseFilterIOKeys>(parameters, keys)
    {
    }
