...
constexpr float left_motor_constant = 5.55;
constexpr float right_motor_constant = 5.55;

constexpr float min_motor_speed_percent = 0;
constexpr float max_motor_speed_percent = 100;

/// Encoders properties
constexpr float left_encoder_wheels_diameter_mm = 47.7;
constexpr float right_encoder_wheels_diameter_mm = 47.7;
...
// Linear speed PID
constexpr float linear_speed_pid_kp = 5;
constexpr float linear_speed_pid_ki = 1;
constexpr float linear_speed_pid_kd = 0;
// Angular speed PID
constexpr float angular_speed_pid_kp = 6;
constexpr float angular_speed_pid_ki = 2;
