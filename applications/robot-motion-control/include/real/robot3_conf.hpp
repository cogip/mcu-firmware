...
constexpr double min_motor_speed_percent = 25;
...
// Linear pose PID
constexpr double linear_pose_pid_kp = 1.0;
constexpr double linear_pose_pid_ki = 0;
constexpr double linear_pose_pid_kd = 0;
// Angular pose PID
constexpr double angular_pose_pid_kp = 1.0;
constexpr double angular_pose_pid_ki = 0;
constexpr double angular_pose_pid_kd = 0;
// Linear speed PID
constexpr double linear_speed_pid_kp = 1.5;
constexpr double linear_speed_pid_ki = 1.0;
constexpr double linear_speed_pid_kd = 0.0;
// Angular speed PID
constexpr double angular_speed_pid_kp = 0.3;
constexpr double angular_speed_pid_ki = 0.25;
constexpr double angular_speed_pid_kd = 0.0;
...
constexpr double max_speed_mm_per_s = 1000;  ///< Maximum speed (mm/s)
...
constexpr double max_speed_deg_per_s = 360; ///< Maximum speed (deg/s)
constexpr double max_acc_deg_per_s2 = 180;  ///< Maximum acceleration (deg/s²)
constexpr double max_dec_deg_per_s2 = 180;  ///< Maximum deceleration (deg/s²)
