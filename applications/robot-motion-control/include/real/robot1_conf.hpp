...
constexpr double min_motor_speed_percent = 10;
...
constexpr double encoder_wheels_distance_mm = 88.0;
...
// Linear speed PID
constexpr double linear_speed_pid_kp = 1.0;
constexpr double linear_speed_pid_ki = 0.0;
constexpr double linear_speed_pid_kd = 0;
// Angular speed PID
constexpr double angular_speed_pid_kp = 1.0;
constexpr double angular_speed_pid_ki = 0.0;
