...
/// Encoders properties
constexpr float left_encoder_wheels_diameter_mm = 60.0;
constexpr float right_encoder_wheels_diameter_mm = 60.0;
constexpr float encoder_wheels_distance_mm = 88.0;
...
// Linear speed PID
constexpr float linear_speed_pid_kp = 1.0;
constexpr float linear_speed_pid_ki = 0.0;
constexpr float linear_speed_pid_kd = 0;
// Angular speed PID
constexpr float angular_speed_pid_kp = 1.0;
constexpr float angular_speed_pid_ki = 0.0;
...
constexpr float max_speed_deg_per_s = 60; ///< Maximum speed (deg/s)
constexpr float max_acc_deg_per_s2 = 30;  ///< Maximum acceleration (deg/s²)
constexpr float max_dec_deg_per_s2 = 30;  ///< Maximum deceleration (deg/s²)
