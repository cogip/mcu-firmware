function initMenu(relPath,searchEnabled,serverSide,searchPage,search) {
    ...
    $('#cogip-navlist').append(makeTree(menudata,relPath));
    if (searchEnabled) {
        $("#MSearchBox").remove();
        if (serverSide) {
            $('#cogip-searchform').attr("id", "FSearchBox");
